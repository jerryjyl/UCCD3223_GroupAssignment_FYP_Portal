...
public class MainAdapter3 extends FirebaseRecyclerAdapter<MainModel3,MainAdapter3.myViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull MainModel3 model) {
            ...
            public void onClick(View v) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("FYP Student List")
