...
public class FYP_UndertakingForm_IIPSPW extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button downloadUFormButton = rootView.findViewById(R.id.downloadFormButton);
        downloadUFormButton.setOnClickListener(v -> checkAndRequestPermissions());
    ...
    private void startDownload() {
        ...
        try {
            InputStream inputStream = assetManager.open("undertakingform.pdf");

            File downloadsDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);
            String destinationPath = downloadsDir.getAbsolutePath() + File.separator + "undertakingform.pdf";
