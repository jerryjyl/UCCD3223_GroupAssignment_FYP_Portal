...
public class MainAdapterIIPSPWStudentList extends RecyclerView.Adapter<MainAdapterIIPSPWStudentList.myViewHolder> {
    Context context;
    ArrayList<MainModel3> list;

    public MainAdapterIIPSPWStudentList(Context context, ArrayList<MainModel3> list) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.main_item_iipspwstudentlist,parent,false);
